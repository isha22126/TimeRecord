...
class GradesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post grades_url, params: { grade: { class_name: @grade.class_name, grade_name: @grade.grade_name } }
    end
  ...
  test "should update grade" do
    patch grade_url(@grade), params: { grade: { class_name: @grade.class_name, grade_name: @grade.grade_name } }
